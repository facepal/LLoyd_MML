...
for sim = 1:num_simulations
    ...
    [cluster_centers_random, ~] = lloyd_clustering_dice(data, K, NP, max_iterations);
    metrics_random_test1 = evaluate_classifier_mc_dice(test1_features, test1_labels, cluster_centers_random, K, NP);
    metrics_random_test2 = evaluate_classifier_mc_dice(test2_features, test2_labels, cluster_centers_random, K, NP);
    ...
    [cluster_centers_kmeanspp, ~] = lloyd_clustering_kmeanspp_dice(data, K, NP, max_iterations);
    metrics_kmeanspp_test1 = evaluate_classifier_mc_dice(test1_features, test1_labels, cluster_centers_kmeanspp, K, NP);
    metrics_kmeanspp_test2 = evaluate_classifier_mc_dice(test2_features, test2_labels, cluster_centers_kmeanspp, K, NP);
