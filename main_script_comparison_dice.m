...
evaluate_classifier_dice(test1_features, test1_labels, cluster_centers_random, K, NP);

disp('Evaluating Lloyd Clustering with Random Initialization on Test2:');
evaluate_classifier_dice(test2_features, test2_labels, cluster_centers_random, K, NP);
...
evaluate_classifier_dice(test1_features, test1_labels, cluster_centers_kmeanspp, K, NP);

disp('Evaluating Lloyd Clustering with K-Means++ Initialization on Test2:');
evaluate_classifier_dice(test2_features, test2_labels, cluster_centers_kmeanspp, K, NP);
