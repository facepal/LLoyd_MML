...
for sim = 1:num_simulations
    ...
    metrics_random_test1 = evaluate_classifier_mc_jacc(test1_features, test1_labels, cluster_centers_random, K, NP);
    metrics_random_test2 = evaluate_classifier_mc_jacc(test2_features, test2_labels, cluster_centers_random, K, NP);
    ...
    metrics_kmeanspp_test1 = evaluate_classifier_mc_jacc(test1_features, test1_labels, cluster_centers_kmeanspp, K, NP);
    metrics_kmeanspp_test2 = evaluate_classifier_mc_jacc(test2_features, test2_labels, cluster_centers_kmeanspp, K, NP);
