function metrics = evaluate_classifier_mc_jacc(test_features, test_labels, cluster_centers, K, NP)
    % Input:
    ...
    for i = 1:N
        ...
        intersection = sum((test_features(i, :) & cluster_centers), 2);
        union = sum((test_features(i, :) | cluster_centers), 2);
        distances = 1 - (intersection ./ union); % Jaccard dissimilarity
