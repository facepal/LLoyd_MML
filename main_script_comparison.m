...
evaluate_classifier(test1_features, test1_labels, cluster_centers_random, K, NP);

disp('Evaluating Lloyd Clustering with Random Initialization on Test2:');
evaluate_classifier(test2_features, test2_labels, cluster_centers_random, K, NP);
...
evaluate_classifier(test1_features, test1_labels, cluster_centers_kmeanspp, K, NP);

disp('Evaluating Lloyd Clustering with K-Means++ Initialization on Test2:');
evaluate_classifier(test2_features, test2_labels, cluster_centers_kmeanspp, K, NP);
